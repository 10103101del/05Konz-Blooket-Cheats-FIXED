...
(() => {
    const cheat = (async () => {
        ...
        footer.innerHTML = (`<span><a target="blank" href="https://discord.gg/jHjGrrdXP6">Discord</a><br/><a target="blank" href="https://github.com/LynixPlayz/05Konz-Blooket-Cheats-FIXED">GitHub - 05Konz</a></span>`);
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/LynixPlayz/05Konz-Blooket-Cheats-FIXED/main/autoupdate/timestamps/mobileGui.png?" + Date.now();
